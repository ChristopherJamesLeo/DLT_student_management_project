...
@section("content")
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12 my-3">
            <form action="{{route('announcements.update',$announcement->id)}}" method="POST" enctype="multipart/form-data" class=""> 
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            <div class="col-md-12 form-group mb-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        <img src="{{asset($announcement->image)}}" width="200px" alt="{{$announcement->title}}">
                                    </div>
                                    <div class="col-md-6">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 form-group mb-1">
                                ...
                                <input type="text" name="title" id="name" class="form-control rounded-0" placeholder="Enter Announce Name" value="{{$announcement->title}}">
                            </div>
                            ...
                            <div class="col-md-12 col-sm-12 form-group mb-1">
                                ...
                                <textarea type="text" name="content" id="content" class="form-control rounded-0" rows="5" placeholder="Say Something..." >{{$announcement->content}}</textarea>
                            </div>
