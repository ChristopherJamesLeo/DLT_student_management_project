                ...
                <tr>
                    ...
                    <td>
                        <div class="form-checkbox form-switch">
                            <input type="checkbox" name="" id="" class="form-check-input change-btn" {{$stage->status_id == "3" ? "checked" : ""}}
                    ...
                    <td>
                        <a href="javascript:void(0)" class="me-3 btn btn-outline-info btn-sm edit_form" data-bs-toggle="modal" data-bs-target="#editmodal" data-id="{{$stage->id}}" data-name="{{$stage->name}}" data-status="{{$stage->status_id}}"><i class="fas fa-pen"></i></a>
                        
                        <a href="#" class="text-danger me-3 delete-btns" data-idx = "{{$stage->id}}" ><i class="fas fa-trash"></i></a>
            ...
            <div class="modal-dialog modal-sm modal-dialog-center">
                <div class="modal-content rounded-0">
                    ...
                    <div class="modal-body">
                        <form id="form_action" action="{{route('stages.store')}}" method="POST" enctype="multipart/form-data" class=""> 
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on("click",".edit_form",function(e){
                ...
                $("#editform_action").attr('action',`/stages/${getid}`);
            ...
            $(".change-btn").click(function(){
                ...
                // change API 
                $.ajax({
                    url : "stagestatus", //route list ထဲရှီ route name ကို ပို့ပေးရမည်
