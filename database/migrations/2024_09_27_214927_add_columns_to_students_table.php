...
return new class extends Migration
{
    ...
    {
        Schema::table('students', function (Blueprint $table) {
            $table -> dropColumn(["image","dob","gender_id","age","email","country_id","city_id","region_id","township_id","address","religion_id","nationalid"]); // column များကိုစုပြီး ဖြုတ်ချ်နိုင်သည်
        });
    }
};
